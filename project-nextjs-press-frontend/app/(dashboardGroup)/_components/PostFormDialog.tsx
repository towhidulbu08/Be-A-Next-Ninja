...
import { createPost } from "../_actions/myPostsActions";
...
export default function PostFormDialog({ mode, post }: PostFormDialogProps) {
  const [open, setOpen] = useState(false);

  const action = mode === "edit" && post ? () => {} : createPost;
